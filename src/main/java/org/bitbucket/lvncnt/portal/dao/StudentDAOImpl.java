...
public class StudentDAOImpl implements Schemacode {
	 ...
	 *  Start application  
	 ************************************/ 
	public int createApplication(int userID, String program, 
			String semester, String year, int[] applicationID){
		
		int result = 0; 
		String sql = "SELECT application_id FROM " + TABLE_APPLICATION_LIST
				+ " WHERE user_id = ? AND school_year = ? AND school_semester = ? AND program = ?";
		try{
			result = jdbcTemplate.queryForObject(sql, new Object[]{
				userID, year, semester, program
			}, Integer.class); 
			...
			jdbcTemplate.update(sql, new Object[]{
					applicationID[0], userID, year, semester, program, new Date()	
			}); 
		}
	...
	public int saveAcademicSchool(int userID, int applicationID, 
			String program, String school) {
		String table = ProgramCode.TABLE_APPLICATION_DETAIL.get(program);
		String sql = "INSERT INTO " + table
				+ " (user_id, application_id, academic_school"
				+ ") VALUES (?,?,?)"
				+ " ON DUPLICATE KEY UPDATE "
				+ "academic_school = VALUES(academic_school)";

		return jdbcTemplate.update(sql, new Object[]{
				userID, applicationID, school 
		}); 
	}
	...
	public List<ApplicationBean> getApplicationList(int userID) {
		// the last 3 years
		String sql = "SELECT * FROM " + TABLE_APPLICATION_LIST
				...
				new RowMapper<ApplicationBean>() {
					...
					public ApplicationBean mapRow(ResultSet reSet, int rowNum)
						...
						if (ampScholarship != null) { // *
							...
							involvementBean.setOtherScholarship(Parse.tryParseInteger(reSet.getString("other_scholarship")));
					...
					public ApplicationBean mapRow(ResultSet reSet, int rowNum)
						...
						if (programEverIn != null) {
							...
							if ("1".equals(ampScholarship)) {
								...
								involvementBean.setAmpScholarshipSemester(reSet.getString("amp_scholarship_semester"));
								involvementBean.setAmpScholarshipYear(reSet.getString("amp_scholarship_year"));
								involvementBean.setAmpScholarshipAmount(Parse.tryParseFloat(reSet.getString("amp_scholarship_amount")));
							}
	 ...
	 ************************************/ 
	public int updateAcademicBean(int userID, int applicationID, 
			String program, AcademicBean academicBean) {
	...
	private int updateAcademicCCCONF(int userID, int applicationID, 
			String table, AcademicBean bean) {
		String sql = "INSERT INTO " + table
				...
				+ "transfer_date,academic_intended_major,academic_referrer"
				+ ") VALUES (?,?,?,?,?,?,?,?,?,?,?,?)"
				+ " ON DUPLICATE KEY UPDATE "
				+ "academic_school = VALUES(academic_school), "
				+ "academic_banner_id = VALUES(academic_banner_id), "
		...
		return jdbcTemplate.update(sql, new Object[]{
				...
				bean.getAcademicSchool(), bean.getAcademicBannerID(), bean.getAcademicMajor(), 
				bean.getAcademicStatus(), bean.getAcademicCredit(), bean.getAcademicGPA(), 
				bean.getAcademicTransferSchool(), bean.getAcademicTransferDate(), 
				bean.getAcademicIntendedMajor(), bean.getAcademicReferrer()
		}); 
	}
	
	private int updateAcademicMESA(int userID, int applicationID, 
			String table, AcademicBean bean) {
		String sql = "INSERT INTO " + table + " (user_id, application_id, "
				+ "academic_school, academic_year, academic_grad_date,"
				+ "academic_gpa,"
				...
				+ "academic_referrer = VALUES(academic_referrer)";
		return jdbcTemplate.update(sql, new Object[]{
				userID, applicationID, bean.getAcademicSchool(), bean.getAcademicYear(), 
				bean.getAcademicGradDate(), bean.getAcademicGPA(), 
				bean.getAcademicTransferSchool(), bean.getAcademicTransferDate(),
				bean.getAcademicIntendedMajor(), bean.getAcademicReferrer()
		}); 
	}
	
	private int updateAcademicSCCORE(int userID, int applicationID, 
			String table, AcademicBean bean) {
		String sql = "INSERT INTO " + table + " (user_id, application_id, "
				...
				+ "academic_banner_id = VALUES(academic_banner_id), "
				+ "academic_major = VALUES(academic_major), "
				+ "academic_minor = VALUES(academic_minor), "
				+ "academic_gpa = VALUES(academic_gpa)";
		return jdbcTemplate.update(sql, new Object[]{
				userID, applicationID, bean.getAcademicSchool(), bean.getAcademicYear(), 
				bean.getAcademicGradDate(), bean.getAcademicBannerID(), 
				bean.getAcademicMajor(), bean.getAcademicMinor(),  bean.getAcademicGPA()
		});  
	}
	
	private int updateAcademicTRANS(int userID, int applicationID, 
			String table, AcademicBean bean) {
		String sql = "INSERT INTO " + table + " (user_id, application_id, "
				+ "academic_school, academic_year, academic_grad_date, academic_banner_id,"
				+ "academic_major,academic_minor,academic_gpa,"
	 ...
	 *********************************/ 
	public int updateInvolvementBean(int userID, int applicationID, 
			String program, InvolvementBean involvementBean) {
	...
	private int updateInvolvementCCCONF(int userID, int applicationID,
			String table, InvolvementBean bean) {
		...
		sql.append("INSERT INTO " + table).append(" (user_id, application_id, ")
				...
				.append("list_employ_start,list_employ_end,")
				.append("ever_in_research,describe_research,")
		...
		return jdbcTemplate.update(sql.toString(), new Object[]{
			...
			bean.getIsCurrentEmploy(), bean.getListEmployCampus(), bean.getListEmployDept(), 
			bean.getListEmploySupervisor(), bean.getListEmployStart(), bean.getListEmployEnd(), 
			bean.getEverInResearch(), bean.getDescribeResearch(), 
			bean.getEverAttendConference(), bean.getProgramEverIn(), 
			bean.getProgramEverInYear() == null ? null: String.valueOf(bean.getProgramEverInYear())
		}); 
 
	}
	
	private int updateInvolvementMESA(int userID, int applicationID,
			String table, InvolvementBean bean) {
		StringBuilder sql = new StringBuilder();
		sql.append("INSERT INTO " + table).append(" (user_id, application_id, ")
				.append("amp_scholarship,amp_scholarship_school,amp_scholarship_type,"
		...
		return jdbcTemplate.update(sql.toString(), new Object[]{
			userID, applicationID, bean.getAmpScholarship(), bean.getAmpScholarshipSchool(), 
	...
	private int updateInvolvementSCCORE(int userID, int applicationID,
			String table, InvolvementBean bean) {
		StringBuilder sql = new StringBuilder();
		sql.append("INSERT INTO " + table).append(" (user_id, application_id, ")
		...
		return jdbcTemplate.update(sql.toString(), new Object[]{
			userID, applicationID, bean.getProgramEverIn(),
			bean.getProgramEverInYear() == null ? null : String.valueOf(bean.getProgramEverInYear()),
			bean.getAmpScholarship(), bean.getAmpScholarshipSchool(), 
			bean.getAmpScholarshipType(), bean.getAmpScholarshipSemester(), bean.getAmpScholarshipYear(), 
			bean.getAmpScholarshipAmount() == null ? null : String.valueOf(bean.getAmpScholarshipAmount()), 
			bean.getOtherScholarship(), bean.getListOtherScholarship()
		}); 
	...
	private int updateInvolvementURS(int userID, int applicationID,
			String table, InvolvementBean bean) {
		StringBuilder sql = new StringBuilder();
		sql.append("INSERT INTO " + table).append(" (user_id, application_id, ")
		...
		return jdbcTemplate.update(sql.toString(), new Object[]{
			userID, applicationID, bean.getProgramEverIn(), bean.getProgramEverInSemesters(),
			bean.getAmpScholarship(), bean.getAmpScholarshipSchool(), 
			bean.getAmpScholarshipType(), bean.getAmpScholarshipSemester(), bean.getAmpScholarshipYear(), 
			bean.getAmpScholarshipAmount() == null ? null : String.valueOf(bean.getAmpScholarshipAmount()), 
			bean.getOtherScholarship(), bean.getListOtherScholarship()
	 ...
	 * Submit Application 
	 */
	public int submitApplication(int userID, String applicationID, 
			String program, SignatureBean signatureBean){
	...
	private int submitApplicationCCCONF(int userID, String applicationID, 
		...
		return jdbcTemplate.update(sql, new Object[]{
			signatureBean.getSignatureDate(), signatureBean.getSignature(), 
			new Date(), applicationID, userID
		}); 
	}
	private int submitApplicationTRANS(int userID, String applicationID, 
			SignatureBean signatureBean){
		...
		if(!hasRecommenderSubmitted(userID, applicationID)){
			...
			params = new Object[]{signatureBean.getSignatureDate(), 
					signatureBean.getSignature(), applicationID, userID}; 
		}else{
	...
	private int submitApplicationIREP(int userID, String applicationID, 
			SignatureBean signatureBean){
		String sql = "UPDATE " + TABLE_APPLICATION_LIST
				+ " SET applicant_submit_date=?,applicant_signature=? "  
				+ "WHERE application_id = ? AND user_id = ?";
		return jdbcTemplate.update(sql, new Object[]{
			signatureBean.getSignatureDate(), signatureBean.getSignature(), 
	 ...
	 * Update Essay Info
	 *********************************/
	public int updateEssayBean(int userID, int applicationID, 
			String program, EssayBean essayBean) {
		String table = ProgramCode.TABLE_APPLICATION_DETAIL.get(program);
		switch (program) {
		// programsTwoYr
		case ProgramCode.CCCONF:
	...
	private int updateEssayCCCONF(int userID, int applicationID,
			String table, EssayBean bean) {
		StringBuilder sql = new StringBuilder();
		sql.append("INSERT INTO " + table).append(" (user_id, application_id, ")
		...
		return jdbcTemplate.update(sql.toString(), new Object[]{
			userID, applicationID, 
			bean.getEssayCriticalEvent(), bean.getEssayEducationalGoal(), 
			bean.getEssayProfesionalGoal(), bean.getEssayAmpGain()
		}); 
	}
	
	private int updateEssayMESA(int userID, int applicationID,
			String table, EssayBean bean) {
		StringBuilder sql = new StringBuilder();
		sql.append("INSERT INTO " + table).append(" (user_id, application_id, ")
		...
		return jdbcTemplate.update(sql.toString(), new Object[]{
			userID, applicationID, bean.getEssayProfesionalGoal(), 
			bean.getEssayAcademicPathway(), bean.getEssayCriticalEvent()
		}); 
	}
	
	private int updateEssaySCCORE(int userID, int applicationID,
			String table, EssayBean bean) {
		StringBuilder sql = new StringBuilder();
		sql.append("INSERT INTO " + table).append(" (user_id, application_id, ")
		...
		return jdbcTemplate.update(sql.toString(), new Object[]{
			userID, applicationID, bean.getSccoreSchoolAttendPref(), 
			bean.getSccoreSchoolAttendAltn(), bean.getEssayFieldOfStudy(), 
			bean.getEssayEducationalGoal(), bean.getEssayPreferredResearch(), 
			bean.getEssayStrengthBring(), bean.getEssayAmpGain() 
		}); 
	}
	
	private int updateEssayTRANS(int userID, int applicationID,
			String table, EssayBean bean) {
		StringBuilder sql = new StringBuilder();
		sql.append("INSERT INTO " + table).append(" (user_id, application_id, ")
		.append("essay_profesional_goal,essay_field_of_interest,essay_critical_event,")
		.append("essay_mentor,essay_amp_gain")
		.append(") VALUES (?,?,?,?,?,?,?) ON DUPLICATE KEY UPDATE ")
		.append("essay_profesional_goal = VALUES(essay_profesional_goal)")
		.append(", essay_field_of_interest = VALUES(essay_field_of_interest)")
		.append(", essay_critical_event = VALUES(essay_critical_event)")
		.append(", essay_mentor = VALUES(essay_mentor)")
		.append(", essay_amp_gain = VALUES(essay_amp_gain)");

		return jdbcTemplate.update(sql.toString(), new Object[]{
			userID, applicationID, bean.getEssayProfesionalGoal(), 
			bean.getEssayFieldOfInterest(), bean.getEssayCriticalEvent(), 
			bean.getEssayMentor(), bean.getEssayAmpGain()
		}); 
	}
	
	private int updateEssayURS(int userID, int applicationID,
			String table, EssayBean bean) {
		StringBuilder sql = new StringBuilder();
		sql.append("INSERT INTO " + table).append(" (user_id, application_id, ")
				.append("essay_educational_goal")
				.append(") VALUES (?,?,?) ON DUPLICATE KEY UPDATE ")
				.append("essay_educational_goal = VALUES(essay_educational_goal)");

		return jdbcTemplate.update(sql.toString(), new Object[]{
			userID, applicationID, bean.getEssayEducationalGoal()
		}); 
	}
	...
	public int updateMentorBean(int userID, int applicationID, MentorBean mentorBean){
		...
		String sql = "INSERT INTO " + table + " (user_id, application_id, "
				+ "mentor_first_name,mentor_last_name,mentor_prefix,mentor_email"
				+ ") VALUES (?,?,?,?,?,?)" + " ON DUPLICATE KEY UPDATE "
		...
		return jdbcTemplate.update(sql, new Object[]{
				userID, applicationID, mentorBean.getMentorFirstName().trim(), 
	...
	public MentorBean getMentorBean(int userID, int applicationID){
		String sql = "SELECT mentor_id FROM "
				+ TABLE_APPLICATION_LIST + " WHERE user_id = ? AND application_id = ?";
		int mentorID = 0;
		try{
			mentorID = jdbcTemplate.queryForObject(sql, 
					new Object[]{userID, applicationID}, Integer.class); 
		}catch(EmptyResultDataAccessException e){
			return null; 
		}
		sql = "SELECT mentor_first_name,mentor_last_name,mentor_prefix,mentor_email FROM "
				+ TABLE_PROFILE_MENTOR + " WHERE mentor_id = ?";
		try{
			return jdbcTemplate.queryForObject(sql, new Object[]{mentorID}, 
				...
				new RowMapper<MentorBean>() {
					...
					public MentorBean mapRow(ResultSet reSet, int rowNum)
						...
						if(reSet.getString("project_title") == null ||
								reSet.getString("mentor_prefix") == null || 
	...
	public int updateIREPMentorBean(int userID, String applicationID, MentorBean mentorBean){
		...
		String sql = "INSERT INTO " + table + " (user_id, application_id, "
				...
				+ "intl_mentor_phone,intl_mentor_email,intl_mentor_country"
				+ ") VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?)" + " ON DUPLICATE KEY UPDATE "
				+ "mentor_first_name = VALUES(mentor_first_name), "
				+ "mentor_last_name = VALUES(mentor_last_name), "
				...
				+ "intl_mentor_phone = VALUES(intl_mentor_phone), "
				+ "intl_mentor_email = VALUES(intl_mentor_email), "
				+ "intl_mentor_country = VALUES(intl_mentor_country)" ;
		return jdbcTemplate.update(sql, new Object[]{
				userID, applicationID, mentorBean.getMentorFirstName(), 
				mentorBean.getMentorLastName(), mentorBean.getMentorInstitution(), 
				mentorBean.getMentorPhone(), mentorBean.getMentorEmail().trim(),
				mentorBean.getIntlMentorFirstName(), mentorBean.getIntlMentorLastName(), 
				mentorBean.getIntlMentorInstitution(), mentorBean.getIntlMentorPhone(), 
				mentorBean.getIntlMentorEmail(), mentorBean.getIntlMentorCountry()
		}); 
	}
	...
	public int updateProjectBean(int userID, int applicationID, ProjectBean projectBean){
		String table = ProgramCode.TABLE_APPLICATION_DETAIL.get(ProgramCode.URS);
		String sql = "INSERT INTO " + table + " (user_id,application_id,"
				+ "project_title,project_is_external,"
				+ "project_external_agency,project_external_title,project_external_duration,"
				+ "project_goal,project_method,project_result,project_task"
				+ ") VALUES (?,?,?,?,?,?,?,?,?,?,?)"
				+ " ON DUPLICATE KEY UPDATE "
		...
		return jdbcTemplate.update(sql, new Object[]{
				userID, applicationID, 
				projectBean.getProjectTitle(), projectBean.getExternalProject(),  
				projectBean.getExternalAgency(), projectBean.getExternalTitle(), 
				projectBean.getExternalDuration(), projectBean.getProjectGoal(), 
				projectBean.getProjectMethod(), projectBean.getProjectResult(), 
				projectBean.getProjectTask() 
		}); 
	}
	...
	public int updateIREPProjectBean(int userID, int applicationID, IREPProjectBean irepProjectBean){
		String table = ProgramCode.TABLE_APPLICATION_DETAIL.get(ProgramCode.IREP);
		String sql = "INSERT INTO " + table + " (user_id,application_id,"
				+ "research_date,leave_date,return_date,"
				+ "ever_fund_amp,list_program,project_abstract"
				+ ") VALUES (?,?,?,?,?,?,?,?)"
				+ " ON DUPLICATE KEY UPDATE "
				+ "research_date = VALUES(research_date), " 
				+ "leave_date = VALUES(leave_date), " 
				+ "return_date = VALUES(return_date), " 
				+ "ever_fund_amp = VALUES(ever_fund_amp), "
				+ "list_program = VALUES(list_program), "
				+ "project_abstract = VALUES(project_abstract) ";
		return jdbcTemplate.update(sql, new Object[]{
				userID, applicationID, 
				irepProjectBean.getResearchDate(), irepProjectBean.getLeaveDate(), irepProjectBean.getReturnDate(),
				irepProjectBean.getEverFundAmp(), irepProjectBean.getListProgram(), irepProjectBean.getProjectAbstract()
		}); 
	}
		...
		try{
			return jdbcTemplate.queryForObject(sql, 
				...
				new RowMapper<MentorBean>() {
					...
					public MentorBean mapRow(ResultSet reSet, int rowNum)
							throws SQLException {
						if(reSet.getString("mentor_first_name") == null ||
								reSet.getString("mentor_email") == null ||
								reSet.getString("mentor_last_name") == null ||
								reSet.getDate("research_date") == null ||
								reSet.getDate("leave_date") == null ||
								reSet.getDate("return_date") == null || 
								reSet.getString("ever_fund_amp") == null ||
	...
	public String updateProjectKeyIREP(int userID, String applicationID){
		...
		try{
			...
			sql = "UPDATE " + table
					+ " SET project_key = ? WHERE user_id = ? AND application_id = ?";
	...
	public IREPProjectBean getProjectAbstractIREP(String projectKey){
		...
		return jdbcTemplate.queryForObject(sql.toString(), 
			...
			@Override
			public IREPProjectBean mapRow(ResultSet reSet, int rowNum)
					throws SQLException {
	...
	public int submitProjectIREP(int userID, int applicationID, SignatureBean bean){
		...
		jdbcTemplate.update(sql1, new Object[]{
			bean.getSignature(), bean.getSignatureDate(), userID, applicationID 	
		}); 
	 ...
	 *********************************/
	public int uploadReference(int userID, String applicationID, 
			String program, FileBucket fileBucket){
		...
		/* update recommender_submit_date in the application_list (student do the submission for MESA) */
		sql = "UPDATE " + TABLE_APPLICATION_LIST + " SET recommender_submit_date = ? "
				+ "WHERE user_id = ? AND application_id = ? ";
		return jdbcTemplate.update(sql, new Object[]{
				Parse.FORMAT_DATETIME.format(new Date()),
				userID, applicationID
		}); 
	}
	...
	public byte[] downloadReference(int userID, String applicationID, String program){
		String table = ProgramCode.TABLE_APPLICATION_DETAIL.get(program);
		String sql = "SELECT reference_content FROM " + table
				+ " WHERE user_id = ? AND application_id = ?";
		try{
	 ...
	 *********************************/
	public int uploadMedicalAuthorization(int userID, String applicationID, 
			String program, FileBucket fileBucket){
	...
	public byte[] downloadMedicalAuthorization(int userID, String applicationID, String program){
		String table = ProgramCode.TABLE_APPLICATION_DETAIL.get(program);
		String sql = "SELECT medical_content FROM " + table
				+ " WHERE user_id = ? AND application_id = ?";
		try{
			return jdbcTemplate.queryForObject(sql, byte[].class, new Object[]{userID, applicationID}); 
		}catch(EmptyResultDataAccessException e){
	 ...
	 *********************************/
	public int uploadTranscript(int userID, int applicationID, 
			String program, FileBucket fileBucket){
	...
	public byte[] downloadTranscript(int userID, String applicationID, String program){
		String table = ProgramCode.TABLE_APPLICATION_DETAIL.get(program);
		String sql = "SELECT transcript_content FROM " + table
				+ " WHERE user_id = ? AND application_id = ?";
		try{
			return jdbcTemplate.queryForObject(sql, byte[].class, new Object[]{userID, applicationID}); 
		}catch(EmptyResultDataAccessException e){
	...
	public int updateBudgetBean(int userID, String applicationID, BudgetBean budgetBean) {
		...
		return jdbcTemplate.update(sql, new Object[]{
				userID, applicationID, 
				budgetBean.getTotalDomesticTravel(), budgetBean.getTotalRoundTrip(), budgetBean.getTotalVisa(), 
				budgetBean.getTotalPassport(), budgetBean.getTotalImmunization(), budgetBean.getTotalHousing(), 
				budgetBean.getTotalCommunication(), budgetBean.getTotalMeal(), budgetBean.getTotalMiscellaneous(), 
				budgetBean.getCurrentDomesticTravel(), budgetBean.getCurrentRoundTrip(), budgetBean.getCurrentVisa(), 
                budgetBean.getCurrentPassport(), budgetBean.getCurrentImmunization(), budgetBean.getCurrentHousing(), 
	...
	public int createSelfReport(int userID, int windowID){
		...
		int result = 0; 
		String sql = "SELECT window_id FROM " + TABLE_SELFREPORT_DATA
		...
		try{
			...
			sql = String.format("INSERT INTO %s (user_id,window_id,semester) SELECT %s,window_id,semester FROM %s WHERE window_id = ?",
	...
	public SelfReportBean getSelfreportBean(int windowID, int userID) {
		String sql = "SELECT * FROM " + TABLE_SELFREPORT_DATA
				+ " WHERE window_id = ? AND user_id = ?";
		 
		try{
			SelfReportBean selfReportBean = jdbcTemplate.queryForObject(sql, 
					new Object[]{windowID, userID}, 
					new RowMapper<SelfReportBean>() {
						@Override
						public SelfReportBean mapRow(ResultSet reSet, int rowNum)
								throws SQLException {
	...
	public List<SelfReportBean> getSelfreportSubmitDates(int userID, boolean onlySubmitted) {
		...
		return jdbcTemplate.query(sql, new Object[]{userID}, 
			new ResultSetExtractor<List<SelfReportBean>>() {
			@Override
			public List<SelfReportBean> extractData(ResultSet reSet)
	...
	public List<SelfReportBean> getSelectedSelfReport(int userID, List<String> idList) {
		...
		return jdbcTemplate.query(sql.toString(), new Object[]{userID}, 
				new RowMapper<SelfReportBean>() {
			...
			public SelfReportBean mapRow(ResultSet reSet, int rowNum) throws SQLException {
				...
				if(reSet.getString("first_name") != null){
					reportAcademicBean.setFirstName(reSet.getString("first_name"));
					reportAcademicBean.setLastName(reSet.getString("last_name"));
					reportAcademicBean.setCurrentAddressLine1(reSet
							.getString("current_address_line1"));
					reportAcademicBean.setCurrentAddressLine2(reSet
							.getString("current_address_line2"));
					reportAcademicBean.setCurrentAddressCity(reSet
							.getString("current_address_city"));
					reportAcademicBean.setCurrentAddressState(reSet
							.getString("current_address_state"));
					reportAcademicBean.setCurrentAddressZip(reSet
							.getString("current_address_zip"));
					reportAcademicBean.setCurrentAddressCountry(reSet
							.getString("current_address_country"));
					reportAcademicBean
							.setSelectSchool(reSet.getString("select_school"));
					reportAcademicBean.setMajor(reSet.getString("major"));
					reportAcademicBean.setGpa(reSet.getString("gpa"));
				}
				selfReportBean.setReportAcademicBean(reportAcademicBean);
	...
	public int updateReportAcademic(int userID, int windowID, String semester, ReportAcademicBean selfReportBean){
		String sql = "INSERT INTO " + TABLE_SELFREPORT_DATA
				...
				+ "current_address_zip,select_school,major,gpa"
				+ ") VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?)"
				+ " ON DUPLICATE KEY UPDATE "
				...
				+ "select_school = VALUES(select_school), "
				+ "major = VALUES(major), "
				+ "gpa = VALUES(gpa) "
				;
		return jdbcTemplate.update(sql, new Object[]{
			windowID, userID, semester, selfReportBean.getFirstName(), selfReportBean.getLastName(), 
	...
	public int updateReportInternship(int userID, int windowID, String semester, String internJson){
		...
		return jdbcTemplate.update(sql.toString(), new Object[]{
			windowID, userID, semester, internJson
		}); 
	}
	...
	public int updateReportTravel(int userID, int windowID, String semester, String travelJson){
		...
		return jdbcTemplate.update(sql.toString(), new Object[]{
			windowID, userID, semester, travelJson
		});  
	}
	...
	public int updateReportConferenceBean(int userID, int windowID, String semester, String conferenceJson){
		...
		return jdbcTemplate.update(sql.toString(), new Object[]{
			windowID, userID, semester, conferenceJson,  
		});  
	}
	...
	public int updateReportPublicationBean(int userID, int windowID, String semester, String publicationJson){
		...
		return jdbcTemplate.update(sql.toString(), new Object[]{
			windowID, userID, semester, publicationJson
		});  
	}
	...
	public int updateReportAwardsBean(int userID, int windowID, String semester, String awardsJson){
		...
		return jdbcTemplate.update(sql.toString(), new Object[]{
			windowID, userID, semester, awardsJson
		});  
	}
	...
	public int updateReportOthersBean(int userID, int windowID, String semester, ReportOthersBean bean){
		...
		return jdbcTemplate.update(sql.toString(), new Object[]{
			windowID, userID, semester,bean.getOtherActivities()
		});  
	}
	
	public int updateReportSubmit(int userID, int windowID, String semester){
		
		String sql = "SELECT first_name,current_address_line1,major,gpa FROM "
				+ TABLE_SELFREPORT_DATA + " WHERE window_id=? AND user_id=? AND semester=?"; 
				...
				public Boolean extractData(ResultSet reSet) throws SQLException,
					...
					if(reSet.next()){
						if(reSet.getString("first_name") != null &&
							...
							reSet.getString("major") != null &&
							reSet.getString("gpa") != null){
							return true; 
						}
					}
					return false;
		...
		return jdbcTemplate.update(sql, new Object[]{
				new Date(), windowID, userID, semester	
		}); 
	}
	...
	public List<RecommenderBean> getRecommenderList(int userID, int applicationID) {
		...
		sql.append("SELECT a.recommender_first_name,a.recommender_last_name,"
						+ "a.recommender_email,a.recommender_institution, "
						+ "b.recommender_submit_date\n");
		sql.append("FROM ").append(table).append(" a \n");
		sql.append("LEFT JOIN ").append(TABLE_APPLICATION_LIST).append(" b\n");
		sql.append("ON a.application_id = b.application_id\n");
		...
		return jdbcTemplate.query(sql.toString(), new Object[]{userID, applicationID}, 
			...
			@Override
			public List<RecommenderBean> extractData(ResultSet reSet)
					throws SQLException, DataAccessException {
	...
	public int updateRecommenderBean(int userID, int applicationID, RecommenderBean bean){
		...
		String sql1 = "SELECT recommender_email FROM " + table
				+ " WHERE user_id = ? AND application_id = ?";
		try{
		...
		String SQL_INSERT = "INSERT INTO " + table
				...
				+ "recommendation_key,recommendation_timeout"
				+ ") VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)"
				+ " ON DUPLICATE KEY UPDATE "
				+ "recommender_first_name = VALUES(recommender_first_name), "
		...
		int result = 0; 
		if(key != null){
			result = jdbcTemplate.update(SQL_INSERT, new Object[]{
				userID, applicationID, bean.getFirstName(), bean.getLastName(), 
				bean.getPrefix(), bean.getEmail().trim(), bean.getInstitution(), bean.getPhone(), 
				bean.getAddressLine1(), bean.getAddressLine2(), bean.getAddressCity(), 
				bean.getAddressState(), bean.getAddressZip(), bean.getAddressCountry(), 
				key[0], Long.parseLong(key[1])
			});  
		}
		if(result != 0){
	...
	private static String[] getRecommendationKey(String email) {
		...
		if (recommendationKey != null) {
			return new String[] { recommendationKey,
					String.valueOf(recommendationTimeout) };
		}
		return null;
	}
	...
	public RecommenderBean resendRecommender(int userID, String applicationID){
		...
		try{
			recommenderBean = jdbcTemplate.queryForObject(sql, new Object[]{userID, applicationID}, 
				...
				@Override
				public RecommenderBean mapRow(ResultSet reSet, int rowNum)
						throws SQLException {
					RecommenderBean bean = new RecommenderBean(); 
					if(reSet.getString("recommender_email") == null) return null; 
					bean.setEmail(reSet.getString("recommender_email"));
					bean.setFirstName(reSet.getString("recommender_first_name"));
					bean.setLastName(reSet.getString("recommender_last_name"));
					return bean;
		...
		if(recommenderBean == null) return null; 
		
		String[] key = getRecommendationKey(recommenderBean.getEmail());
		if (key != null) {
			sql = "UPDATE " + table
					+ " SET recommendation_key = ?, recommendation_timeout = ?"
					+ " WHERE user_id = ? AND application_id = ?";
			int result = jdbcTemplate.update(sql, new Object[]{
					key[0], Long.parseLong(key[1]), userID, applicationID 
				}); 
			if(result != 0){
	...
	public int uploadRecommandation(String recommendationKey, FileBucket fileBucket){
		...
		String sql = "UPDATE " + table
				+ " SET recommendation_file_name = ?, recommendation_file_type = ?,"
				+ "recommendation_file_size=?,recommendation_file_content=?"
		...
		try{
			applicationBean = jdbcTemplate.queryForObject(sqlSelect.toString(), 
				new Object[]{recommendationKey}, 
				new RowMapper<ApplicationBean>(){
		...
		if(applicationBean == null)return 0; 
		
		if(applicationBean.getApplicantSubmitDate() != null){
			sql = "UPDATE " + TABLE_APPLICATION_LIST + " SET recommender_submit_date=?,complete_date=? WHERE application_id = ?"; 
			return jdbcTemplate.update(sql, new Object[]{new Date(), new Date(), applicationBean.getApplicationID()}); 
		}else{
	...
	public boolean hasRecommenderSubmitted(int userID, String applicationID){
		String sql = "SELECT recommender_submit_date FROM "
				+ TABLE_APPLICATION_LIST + " WHERE application_id = ? AND user_id = ?";
		try{
			return jdbcTemplate.query(sql, new Object[]{applicationID, userID}, 
				new ResultSetExtractor<Boolean>(){
				@Override
				public Boolean extractData(ResultSet reSet) throws SQLException,
						DataAccessException {
	...
	public boolean isApplicationCompleteByCompleteDate(int menteeID, int applicationID){
		String sql = "SELECT complete_date FROM "
				+ TABLE_APPLICATION_LIST + " WHERE application_id = ? AND user_id = ?";
		try{
			return jdbcTemplate.query(sql, new Object[]{applicationID, menteeID}, 
				new ResultSetExtractor<Boolean>(){
				@Override
				public Boolean extractData(ResultSet reSet) throws SQLException,
						DataAccessException {
	...
	public boolean isApplicationIComplete(int userID, String applicationID, String program){
		...
		// programsTwoYr
		case ProgramCode.CCCONF:
			sql.append("SELECT academic_school,academic_major,amp_scholarship,essay_educational_goal,transcript_name \n");
			sql.append("FROM ").append(table).append(" \n");
			sql.append("WHERE user_id = ? AND application_id=?"); 
			return isApplicationICompleteCCCONF(params, sql); 
		case ProgramCode.SCCORE:
			sql.append("SELECT academic_school,academic_major,amp_scholarship,essay_educational_goal,transcript_name,medical_name \n");
			sql.append("FROM ").append(table).append(" \n");
			sql.append("WHERE user_id = ? AND application_id=?"); 
			return isApplicationICompleteSCCORE(params, sql); 
			
		case ProgramCode.MESA:
			sql.append("SELECT academic_school,academic_grad_date,amp_scholarship,essay_profesional_goal,transcript_name,reference_name \n");
			sql.append("FROM ").append(table).append(" \n");
			sql.append("WHERE user_id = ? AND application_id=?"); 
			return isApplicationICompleteMESA(params, sql); 
			
		case ProgramCode.TRANS: // DO NOT check recommendation info
			sql.append("SELECT academic_school,academic_grad_date,amp_scholarship,essay_profesional_goal,transcript_name \n");
			sql.append("FROM ").append(table).append(" \n");
			sql.append("WHERE user_id = ? AND application_id=?"); 
		...
		// programsFourYr
		case ProgramCode.URS:
			sql.append("SELECT academic_school,academic_grad_date,amp_scholarship,transcript_name,mentor_email,essay_educational_goal \n");
			sql.append("FROM ").append(table).append(" \n");
			sql.append("WHERE user_id = ? AND application_id=?"); 
			return isApplicationICompleteURS(params, sql); 
		case ProgramCode.IREP:
			sql.append("SELECT academic_school,academic_grad_date,mentor_email,transcript_name,budget_total_domestictravel \n");
			sql.append("FROM ").append(table).append(" \n");
			sql.append("WHERE user_id = ? AND application_id=?"); 
			...
			return jdbcTemplate.query(sql.toString(), params, 
				...
				public Boolean extractData(ResultSet reSet) throws SQLException,
					...
					if (reSet.next()) {
						...
						if(academicInfo != null && reSet.getString("academic_major") != null
								&& invInfo != null && transcriptInfo != null 
								&& essayInfo != null){
							return true;
						}
					}
			...
			return jdbcTemplate.query(sql.toString(), params, 
				...
				public Boolean extractData(ResultSet reSet) throws SQLException,
					...
					if (reSet.next()) {
						...
						if(academicInfo != null && reSet.getString("academic_major") != null
								&& invInfo != null && transcriptInfo != null 
								&& essayInfo != null && medicalInfo != null){
							return true;
						}
					}
					return false;
				...
				public Boolean extractData(ResultSet reSet) throws SQLException,
					...
					if (reSet.next()) {
						...
						if(academicInfo != null 
								&& reSet.getDate("academic_grad_date") != null
								&& invInfo != null && transcriptInfo != null 
								&& essayInfo != null & referenceInfo != null){
							return true;
						}
					}
					return false;
				...
				public Boolean extractData(ResultSet reSet) throws SQLException,
					...
					if (reSet.next()) {
						...
						if(academicInfo != null 
								&& reSet.getDate("academic_grad_date") != null
								&& invInfo != null && transcriptInfo != null 
								&& mentorInfo != null && essayInfo != null){
							return true;
						}
					}
					return false;
			...
			return jdbcTemplate.query(sql.toString(), params, 
				...
				public Boolean extractData(ResultSet reSet) throws SQLException,
					...
					if (reSet.next()) {
						...
						if(academicInfo != null 
								&& reSet.getDate("academic_grad_date") != null
								&& budgetInfo != null && transcriptInfo != null 
								&& mentorInfo != null ){
							return true;
						}
					}
	...
	public boolean isApplicationIICompleteURS(int userID, String applicationID){
		String sql = "SELECT mentor_submit_date FROM "
				+ TABLE_APPLICATION_LIST + " WHERE application_id = ? AND user_id = ?";
		try{
			return jdbcTemplate.query(sql, new Object[]{applicationID, userID}, 
				new ResultSetExtractor<Boolean>(){
	...
	public List<EvaluationBean> getEvaluations(int menteeID) {
		...
		sql.append("FROM ").append(TABLE_EVAL_MIDTERM_STU).append(" AS a\n")
		   ...
		   .append("ON a.mentee_id = b.user_id").append(" WHERE a.mentee_id=? )\n");
		return jdbcTemplate.query(sql.toString(), new Object[]{menteeID}, 
	...
	public int setEvaluationMidTerm(String applicationID, String evalYear, 
		...
		return jdbcTemplate.update(sql.toString(), new Object[]{ 
	        map.get("quest-1"), map.get("quest-2"), map.get("quest-3"), 
