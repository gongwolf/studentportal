<html><body><br />${date}<br /><br />${bean.firstName} ${bean.lastName}<br />${bean.addressLine1}<br />${bean.addressCity}, ${bean.addressState} ${bean.addressZip}<br /><br />Dear ${bean.firstName},<br /><br /><p>Your application for the New Mexico Alliance for Minority Participation (New Mexico AMP) International Research and Education Participation&nbsp;program for the Spring 2017 has been reviewed. Unfortunately, we are unable at this time to offer you a New Mexico AMP URS position.<br />
<br />
