...
function validate(){
	var isChecked = false; 
	var radioNames = ["rating-report","rating-has","rating-complete","rating-demonstrate","rating-gain","radio-meet"]; 
	...
	var textareaNames = ["quest-assessment","quest-conference","quest-concern","quest-assist"]; 
