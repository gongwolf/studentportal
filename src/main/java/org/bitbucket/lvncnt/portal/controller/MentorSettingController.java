...
@Controller
@RequestMapping("/mentor/setting")
public class MentorSettingController {
	
	private static final String VIEW_SETTING = "mentor/setting"; 
	...
	public View setProfilePassword(ModelMap model,
